...
public class BootBlockPage extends page {
	public String get(PlusThreeDiskWrapper disk) {
		...
		result = result + "<h1>Boot block</h1>\r\n";
		result = result + "<table>\r\n";
		...
		result = result + "<tr><td><b>Hard Format type</b></td><td>" + disktype + "</td></tr>\r\n";
		result = result + "<tr><td><b>Sides</b></td><td>" + String.valueOf(disk.numsides) + "</td></tr>\r\n";
		result = result + "<tr><td><b>Tracks per side</b></td><td>" + String.valueOf(disk.numtracks)
				+ "</td></tr>\r\n";
		result = result + "<tr><td><b>Sectors per track</b></td><td>" + String.valueOf(disk.numsectors)
				+ "</td></tr>\r\n";
		result = result + "<tr><td><b>Log2(sz)-7 (sector size)</b></td><td>"
				+ String.valueOf(disk.sectorPow) + " (" + disk.sectorSize + "  bytes/sector) </td></tr>\r\n";
		result = result + "<tr><td><b>Reserved blocks</b></td><td>" + String.valueOf(disk.reservedTracks)
				+ "</td></tr>\r\n";
	
		result = result + "<tr><td><b>Block size</b></td><td>" + String.valueOf(disk.blockPow)+" ("+String.valueOf(disk.blockSize)+" bytes block size)" + "</td></tr>\r\n";
		result = result + "<tr><td><b>No directory blocks</b></td><td>" + String.valueOf(disk.dirBlocks)
				+ "</td></tr>\r\n";
		result = result + "<tr><td><b>read/write gap length</b></td><td>" + String.valueOf(disk.rwGapLength)
				+ "</td></tr>\r\n";
		result = result + "<tr><td><b>format gap length</b></td><td>" + String.valueOf(disk.fmtGapLength)
				+ "</td></tr>\r\n";
		result = result + "<tr><td><b>Checksum fiddle byte</b></td><td>"
		...
		result = result + "<tr><td><b>Checksum:</b></td><td>" + csumtype + " (#" + String.valueOf(disk.checksum)
				+ ")" + "</td></tr>\r\n";
		result = result + "</table>\r\n<br>\r\n";
		...
		result = result + "<tr><th colspan=4>" + "Disassembled boot block " + "</td></tr>\r\n";
		result = result + "<tr><th>Loaded address</th><th>Hex</th><th>Asm</th><th>chr</th></tr>\r\n";
		...
		while (realaddress < 0x200) {
			...
			result = result + "<tr><td>" + IntAndHex(loadedaddress) + "</td><td>" + hex + "</td><td>"
					+ Instruction.instruction + "</td><td>" + chrdata.substring(0, Instruction.length)
					+ "</td></tr>\r\n";
//			System.out.println(IntAndHex(loadedaddress) + "\t" +Instruction.instruction);
		...
		result = result + "<table class=\"hex\">\r\n";
		result = result + "<tr><th colspan=3>" + "<b>Raw Boot block data</b> " + "</td></tr>\r\n";
		// sector data
		String hexdata = "";
		String chardata = "";
		...
		result = result + "<tr><td>" + starttext + "</td><td>" + hexdata + "</td><td>" + chardata + "</td></tr>\r\n";
		result = result + "</table>\r\n<br>\r\n";
